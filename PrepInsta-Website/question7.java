...
public class question7 {
    public static void main(String[] args) {
        ...
        int totalCandies = 10;
        int minCandies = 2; // minimum candies that must be inside the JAR
        ...
        if (candies > totalCandies) {
            ...
            System.out.println("No of candies sold: " + candies);

            int remainingCandies = (totalCandies - candies) ; 

            System.out.println("No of candies available: " + remainingCandies );
        }
